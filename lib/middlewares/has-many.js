  ...
  rest.registerEndpoint(
    {
      ...
      middlewares: [wrap(findAll({collection, foreignCollection, foreignKey}))],
  ...
  rest.registerEndpoint(
    {
      ...
      middlewares: [wrap(pick({collection, foreignCollection, foreignKey}))],
      description: "get " + relation.name
    }
  );
  ...
  rest.registerEndpoint(
    {
      ...
      method: "post",
      route: '/:id/' + relation.name,
      middlewares: [wrap(create({collection, foreignCollection, foreignKey}))],
  ...
  rest.registerEndpoint(
    {
      ...
      method: "put",
      route: '/:id/' + relation.name + '/:fk',
      middlewares: [wrap(update({collection, foreignCollection, foreignKey}))],
      description: "create " + relation.name
    }
  );
  ...
  rest.registerEndpoint(
    {
      ...
      method: "delete",
      route: '/:id/' + relation.name + '/:fk',
      middlewares: [wrap(destroy({collection, foreignCollection, foreignKey}))],
