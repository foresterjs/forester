...
class Rest {
    ...
    constructor(app) {
        ...
        this.registrationsMethod = {
            crud: middlewaresCrud.register,
            relations: {
                belongsTo: middlewaresBelongsTo.register,
                hasMany: middlewaresHasMany.register,
                hasOne: middlewaresHasOne.register,
                hasAndBelongsToMany: middlewaresHasAndBelongsToMany.register,
                hasManyThrough: middlewaresHasManyThrough.register
            }
        };
