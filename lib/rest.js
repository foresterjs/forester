...
class Rest {
    ...
    constructor(app) {
        ...
        var relationType = {
            ...
            hasManyThrough: "registerHasManyThrough"
        };
    ...
    registerHasManyThrough(collection, fieldName, options) {
        ...
        this.registerEndpoint(
            {
                ...
                method: "get",
                route: '/:id/' + fieldName,
                middlewares: [middlewaresHasManyThrough.find({
                    collection,
                    foreignCollection,
                    throughCollection,
                    key,
        ...
        this.registerEndpoint(
            {
                ...
                method: "get",
                route: '/:id/' + fieldName + '/:fk/',
                middlewares: [middlewaresHasManyThrough.findById({
                    collection,
                    foreignCollection,
                    throughCollection,
                    key,
        ...
        this.registerEndpoint(
            {
                ...
                method: "post",
                route: '/:id/' + fieldName + '/:fk',
                middlewares: [middlewaresHasManyThrough.create({
                    collection,
                    foreignCollection,
                    throughCollection,
                    key,
        ...
        this.registerEndpoint(
            {
                ...
                method: "delete",
                route: '/:id/' + fieldName + '/:fk',
                middlewares: [middlewaresHasManyThrough.destroy({
                    collection,
                    foreignCollection,
                    throughCollection,
                    key,
